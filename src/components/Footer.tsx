  ...
  return (
    <footer className="site-footer" data-theme="dark">
      <div className="footer-main flex flex-col md:flex-row md:items-center md:justify-between">
        <a className="footer-brand inline-flex items-center gap-3" href="#top" aria-label="HackUTA 2026 — back to the beginning"><Logo className="site-logo site-logo--footer" /><span>2026</span></a>
