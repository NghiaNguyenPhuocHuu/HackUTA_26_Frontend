  ...
  return (
    <footer className="site-footer" data-theme="dark">
      <div className="footer-main flex flex-col md:flex-row md:items-center md:justify-between">
        <a className="footer-brand inline-flex items-center gap-3" href="#top" aria-label="HackUTA 2026 — back to the beginning"><Wordmark className="footer-wordmark" light /><span>2026</span></a>
        <nav className="footer-nav flex flex-wrap items-center" aria-label="Footer"><a href="#about">The crew</a><a href="#schedule">The weekend</a><a href="#sponsors">The supporters</a></nav>
